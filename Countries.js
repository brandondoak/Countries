var country=["Place Holder", "Afghanistan", "Algeria", "Argentina", "Australia", "Austria", "Azerbaijan", "Bangladesh", "Belarus", "Belgium", "Belize", "Bolivia", "Bosnia and Herzegovina", "Botswana", "Brazil", "Bulgaria", "Cambodia", "Cameroon", "Canada", "Central African Republic", "Chad", "Chile", "China", "Colombia", "Democratic Republic of Congo", "Republic of Congo", "Cote d'Ivoire", "Croatia", "Cuba", "Czech Republic", "Denmark", "Djibouti", "Dominican Republic", "Ecuador", "Egypt", "El Salvador", "Eritrea", "Estonia", "Ethiopia", "Fiji", "Finland", "France", "Gabon", "Georgia", "Germany", "Ghana", "Greece", "Guatemala", "Haiti", "Honduras", "Hungary", "Iceland", "India", "Indonesia", "Iran", "Iraq", "Ireland", "Israel", "Italy", "Jamaica", "Japan", "Jordan", "Kazakhstan", "Kenya", "Kuwait", "Laos", "Lebanon", "Lesotho", "Libya", "Madagascar", "Malaysia", "Mali", "Mexico", "Monaco", "Mongolia", "Morocco", "Mozambique", "Namibia", "Netherlands", "New Zealand", "Nicaragua", "Niger", "Nigeria", "North Korea", "Norway", "Oman", "Pakistan", "Panama", "Papua New Guinea", "Paraguay", "Peru", "Philippines", "Poland", "Portugal", "Qatar", "Romania", "Russia", "Rwanda", "Saudi Arabia", "Senegal", "Serbia", "Sierra Leone", "Singapore", "Slovakia", "Slovenia", "Somalia", "South Africa", "South Korea", "South Sudan", "Spain", "Sri Lanka", "Sudan", "Sweden", "Switzerland", "Syria", "Tanzania", "Thailand", "Togo", "Trinidad and Tobago", "Tunisia", "Turkey", "Uganda", "Ukraine", "United Arab Emirates", "United Kingdom (UK)", "United States of America", "Uruguay", "Venezuela", "Vietnam", "Yemen", "Zambia", "Zimbabwe"]
var qA=0;
var qB=0;
var qC=0;
var qD=0;
...
var qAY=function(){
	qA=1;
	q1=1;
	document.getElementById('qAY').style.background="red";
	document.getElementById('qAN').style.background="grey";
}
var qAN=function(){
	qA=0;
	q1=1;
	document.getElementById('qAN').style.background="red";
	document.getElementById('qAY').style.background="grey";
}
var qBY=function(){
	qB=256;
	q2=1;
	document.getElementById('qBY').style.background="red";
	document.getElementById('qBN').style.background="grey";
}
var qBN=function(){
	qB=0;
	q2=1;
	document.getElementById('qBN').style.background="red";
	document.getElementById('qBY').style.background="grey";
}
var qCY=function(){
	qC=65792;
	q3=1;
	document.getElementById('qCY').style.background="red";
	document.getElementById('qCN').style.background="grey";
}
var qCN=function(){
	qC=0;
	q3=1;
	document.getElementById('qCN').style.background="red";
	document.getElementById('qCY').style.background="grey";
}
var qDY=function(){
	qD=128;
	q4=1;
	document.getElementById('qDY').style.background="red";
	document.getElementById('qDN').style.background="grey";
}
var qDN=function(){
	qD=0;
	q4=1;
	document.getElementById('qDN').style.background="red";
	document.getElementById('qDY').style.background="grey";
}
var qEY=function(){
	qE=1024;
	q5=1;
	document.getElementById('qEY').style.background="red";
	document.getElementById('qEN').style.background="grey";
}
var qEN=function(){
	qE=0;
	q5=1;
	document.getElementById('qEN').style.background="red";
	document.getElementById('qEY').style.background="grey";
}
var qFY=function(){
	qF=131584;
	q6=1;
	document.getElementById('qFY').style.background="red";
	document.getElementById('qFN').style.background="grey";
}
var qFN=function(){
	qF=0;
	q6=1;
	document.getElementById('qFN').style.background="red";
	document.getElementById('qFY').style.background="grey";
}
var qGY=function(){
	qG=32;
	q7=1;
	document.getElementById('qGY').style.background="red";
	document.getElementById('qGN').style.background="grey";
}
var qGN=function(){
	qG=0;
	q7=1;
	document.getElementById('qGN').style.background="red";
	document.getElementById('qGY').style.background="grey";
}
var qHY=function(){
	qH=512;
	q8=1;
	document.getElementById('qHY').style.background="red";
	document.getElementById('qHN').style.background="grey";
}
var qHN=function(){
	qH=0;
	q8=1;
	document.getElementById('qHN').style.background="red";
	document.getElementById('qHY').style.background="grey";
}
var qIY=function(){
	qI=8224;
	q9=1;
	document.getElementById('qIY').style.background="red";
	document.getElementById('qIN').style.background="grey";
}
var qIN=function(){
	qI=0;
	q9=1;
	document.getElementById('qIN').style.background="red";
	document.getElementById('qIY').style.background="grey";
}
var qJY=function(){
	qJ=8;
	q10=1;
	document.getElementById('qJY').style.background="red";
	document.getElementById('qJN').style.background="grey";
}
var qJN=function(){
	qJ=0;
	q10=1;
	document.getElementById('qJN').style.background="red";
	document.getElementById('qJY').style.background="grey";
}
var qKY=function(){
	qK=2;
	q11=1;
	document.getElementById('qKY').style.background="red";
	document.getElementById('qKN').style.background="grey";
}
var qKN=function(){
	qK=0;
	q11=1;
	document.getElementById('qKN').style.background="red";
	document.getElementById('qKY').style.background="grey";
}
var qLY=function(){
	qL=16;
	q12=1;
	document.getElementById('qLY').style.background="red";
	document.getElementById('qLN').style.background="grey";
}
var qLN=function(){
	qL=0;
	q12=1;
	document.getElementById('qLN').style.background="red";
	document.getElementById('qLY').style.background="grey";
}
var qMY=function(){
	qM=4;
	q13=1;
	document.getElementById('qMY').style.background="red";
	document.getElementById('qMN').style.background="grey";
}
var qMN=function(){
	qM=0;
	q13=1;
	document.getElementById('qMN').style.background="red";
	document.getElementById('qMY').style.background="grey";
}
var qNY=function(){
	qN=64;
	q14=1;
	document.getElementById('qNY').style.background="red";
	document.getElementById('qNN').style.background="grey";
}
var qNN=function(){
	qN=0;
	q14=1;
	document.getElementById('qNN').style.background="red";
	document.getElementById('qNY').style.background="grey";
}
var qOY=function(){
	qO=2056;
	q15=1;
	document.getElementById('qOY').style.background="red";
	document.getElementById('qON').style.background="grey";
}
var qON=function(){
	qO=0;
	q15=1;
	document.getElementById('qON').style.background="red";
	document.getElementById('qOY').style.background="grey";
}
var qPY=function(){
	qP=32896;
	q16=1;
	document.getElementById('qPY').style.background="red";
	document.getElementById('qPN').style.background="grey";
}
var qPN=function(){
	qP=0;
	q16=1;
	document.getElementById('qPN').style.background="red";
	document.getElementById('qPY').style.background="grey";
}
var qQY=function(){
	qQ=263168;
	q17=1;
	document.getElementById('qQY').style.background="red";
	document.getElementById('qQN').style.background="grey";
}
var qQN=function(){
	qQ=0;
	q17=1;
	document.getElementById('qQN').style.background="red";
	document.getElementById('qQY').style.background="grey";
}
var qRY=function(){
	qR=16448;
	q18=1;
	document.getElementById('qRY').style.background="red";
	document.getElementById('qRN').style.background="grey";
}
var qRN=function(){
	qR=0;
	q18=1;
	document.getElementById('qRN').style.background="red";
	document.getElementById('qRY').style.background="grey";
}
var qSY=function(){
	qS=4112;
	q19=1;
	document.getElementById('qSY').style.background="red";
	document.getElementById('qSN').style.background="grey";
}
var qSN=function(){
	qS=0;
	q19=1;
	document.getElementById('qSN').style.background="red";
	document.getElementById('qSY').style.background="grey";
}

var tally=function() {
	var score=qA*1+qB*1+qC*1+qD*1+qE*1+qF*1+qG*1+qH*1+qI*1+qJ*1+qK*1+qL*1+qM*1+qN*1+qO*1+qP*1+qQ*1+qR*1+qS*1
if (q1===0 || q2===0 || q3===0 || q4===0 || q5===0 || q6===0 || q7===0 || q8===0 || q9===0 || q10===0 || q11===0 || q12===0 || q13===0 || q14===0 || q15===0 || q16===0 || q17===0 || q18===0 || q19===0) {
	document.getElementById('text').innerHTML="Not all the questions were answered";
	document.getElementById('y').src="data:image/jpeg;base64,";
} else {
	switch (score) {
		case 186326:
...
var restart=function () {
	...
	document.getElementById('qRN').style.background="grey";
	document.getElementById('qSN').style.background="grey";
	document.getElementById('text').innerHTML="The Country is";
	document.getElementById('y').src="data:image/png;base64,";
}
